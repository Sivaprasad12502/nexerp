...
export type ReceiptRecordType = "PAYOUT_RECEIPT" | "VENDOR_ADVANCE";
...
export function RecordNewPayoutModal({ open, onClose, onSelect }: Props) {
  return (
    <Modal
      open={open}
      onClose={onClose}
      title="Record New Payout"
      description="Which payout would you like to record?"
    >
      <div className="grid gap-4 sm:grid-cols-2">
        <button
          type="button"
          onClick={() => onSelect("PAYOUT_RECEIPT")}
        ...
        >
          ...
          <span className="font-semibold text-[#7438dc]">Payout Receipt</span>
        </button>
        <button
          type="button"
          onClick={() => onSelect("VENDOR_ADVANCE")}
        ...
        >
          ...
          <span className="font-semibold text-[#7438dc]">Vendor Advance</span>
        </button>
      </div>

...
import { AddPaymentAccountModal } from "../../components/add-payment-account-modal";
import { AddUpiAccountModal } from "../../components/add-upi-account-modal";
...
export default function BankDetailsPage({
  ...
  const handleSaveContinue = async () => {
    ...
    try {
      ...
      router.push(`/sales-and-invoices/documents/${id}`);
    } catch {
